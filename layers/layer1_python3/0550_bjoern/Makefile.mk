...
$(PYTHON3_SITE_PACKAGES)/$(NAME)-3.0.0-py$(PYTHON3_SHORT_VERSION)-linux-x86_64.egg/bjoern.py:
	...
	$(MAKE) --file=$(MFEXT_HOME)/share/Makefile.standard EXPLICIT_NAME=bjoern-metwork EXTRACFLAGS="-I$(MFEXT_HOME)/opt/core/include" EXTRALDFLAGS="-L$(MFEXT_HOME)/opt/core/lib" python3build python3install
